...
func _ready():
    ...
    var plaza_de_mayo = EstacionClass.new("Plaza de Mayo", "PM", [-58.3709684989674, -34.6088103091689], {}, {"PE": 1}, true, 0)
    var peru = EstacionClass.new("Perú", "PE", [-58.3742677264304,-34.6085590738532], {"D": "(ID de Catedral)", "E": "(ID de Bolívar)"}, {"PM": 1, "PI": 1}, true, 2)
    ...
    var saenz_pena = EstacionClass.new("Saenz Peña", "SP", [-58.3867771940873,-34.6094125865027], {}, {"LI": 1, "CO": 1}, false, 2)
    var congreso = EstacionClass.new("Congreso", "CO", [-58.3926688246648,-34.6092256843174], {}, {"SP": 1, "PA": 1}, true, 2)
    var pasco = EstacionClass.new("Pasco", "PA", [-58.3984269918123,-34.6096459617052], {}, {"CO": 1, "AL": 1}, false, 0)
    var alberti = EstacionClass.new("Alberti", "AL", [-58.401207534233,-34.6098335784398], {}, {"PA": 1}, false, 0)
