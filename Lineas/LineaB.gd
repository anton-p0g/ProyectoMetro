...
func _ready():
	...
	var carlos_pellegrim = Estacion.new("Carlos Pellegrim", 33, [-34.6036371051817, -58.380714847140800], {"D": "(PlaceHolder ID 9 de Julio)"}, 
	                                    {32: 1.180, 34: 1.166, "(PlaceHolder ID 9 de Julio)": 2}, false, 2)
	...
	var horario = {"Lunes": "5:00 - 22:49", "Martes":"5:00 - 22:49", "Miercoles": "5:00 - 22:49", "Jueves": "5:00 - 22:49",
	               "Viernes": "5:00 - 22:49", "Sabado": "5:00 - 22:49", "Domingo": "8:00 - 22:25"}
	var frecuencia = {"5:00 - 22:49": 4, "5:00 - 22:49": 7, "8:00 - 22:25": 7}
	var linea_b = LineaClass.new("B", Color(1, 0, 0), horario, frecuencia)
